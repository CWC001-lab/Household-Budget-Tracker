...
public class DashboardForm : Form
{
    ...
    private void InitializeComponents()
    {
        ...
        // Adding tabs
        string[] buttonNames = { "Transactions", "Budget", "Analytics", "Profile", "Logout" };
        EventHandler[] eventHandlers = { DisplayTransactionsButton_Click, BudgetButton_Click, AnalyticsButton_Click, ProfileButton_Click, LogoutButton_Click };
        ...
        // Smaller card panel for content and buttons jaha par NGN wagera show hoga 
    ...
    private void DisplayTopTransactions(string email)
    {
        ...
        try
        {
            ...
            for (int i = 0; i < topTransactions.Count; i++)
            {
                ...
                {
                    Text = $"NGN {Math.Abs(transaction.Amount)}",
                    AutoSize = false,
